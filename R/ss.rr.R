...
#' @param lsl Numeric value of lower spec limit used with USL to calculate study variation as \%Tolerance
#' @param usl Numeric value of upper spec limit used with LSL to calculate study variation as \%Tolerance
...
ss.rr <- function(var, part, appr,
  ...
  if(is.na(usl) | is.na(lsl)){
    ...
    plot <- barchart(databar, 
                     ...
                     stack = FALSE,
                     horizontal = FALSE,
                     main = list("Components of Variation",
                                 fontsize = 14))  
  }  
  else{  
    databar <- cbind(varComp[c(1, 2, 3, 6), 2],
    ...
    plot <- barchart(databar, 
                     ...
                     auto.key = list(text = c("%Contribution", 
                                              "%Study Var", 
                                              "%Tolerance"), 
                                     cex = 0.8,
                                     columns = 2,
